# Building and running remotely (OpenShift)
...
NOTE: Connecting to the database require GSSAPI configuration of your `psql` client (which is a mystery to me, and you are on your own), otherwise use port-forwarding:
